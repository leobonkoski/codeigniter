		...
		<table class="table table-bordered table-hover">
			...
			function mask($val, $mask)
			{
                ...
                <tr>
                    ...
                    <td><?= $user['inactive']?></td>
                    <td>
						<a href="http://localhost/codeigniter/users/edit_user/<?= $user['id'] ?>" class="btn  btn-sm btn-warning">
							<i class= "fas fa-pencil-alt"></i>
						</a>

						<a href="http://localhost/codeigniter/users/inactive_user/<?= $user['id'] ?>" class="btn  btn-sm btn-danger">
